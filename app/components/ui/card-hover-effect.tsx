...
export const HoverEffect = ({
  ...
  return (
    <div className="h-[50rem] flex flex-col py-8  antialiased bg-gray-900 dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
